...
CAMPOS = {
    ...
    'corte':      'Número de corte (C-004)',
    'corte_sigla':'Sigla del corte',
    'precio':     'Precio',
    'cliente':    'Cliente',
...
def datos_de_item(item):
    ...
    return datos_muestra({
        ...
        'corte':      _texto_o_vacio(item.corte.numero) if item.corte else '',
        'corte_sigla': _texto_o_vacio(item.corte.sigla) if item.corte else '',
