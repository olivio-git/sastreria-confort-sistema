...
urlpatterns = [
    ...
    path('alquileres/<int:id>/cambiar-unidad/', views.cambiar_unidad_alquiler, name='cambiar_unidad_alquiler'),
    ...
    path('prendas/items/<int:id>/mover/', views.mover_prenda_item, name='mover_prenda_item'),
    ...
    path('inventario/items/buscar/', views_etiquetas.buscar_items, name='buscar_items_inventario'),
